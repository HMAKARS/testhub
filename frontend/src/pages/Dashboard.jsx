        ...
        <DashboardLayout>
            <div className="text-center space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
                    ...
                    <Link to="/dashboard/api" className="block p-6 rounded-lg shadow bg-white dark:bg-neutral-800 hover:bg-blue-50 transition">
                        <h2 className="text-lg font-semibold text-green-600">API 테스트</h2>
